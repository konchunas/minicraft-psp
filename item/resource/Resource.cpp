...
Resource * Resource::flower = new PlantableResource("Flower", 0 + 4 * 32, Color::get(-1, 10, 444, 330), Tile::flower, 1, Tile::grass);
Resource * Resource::acorn = new PlantableResource("Acorn", 3 + 4 * 32, Color::get(-1, 100, 531, 320), Tile::treeSapling, 1, Tile::grass);
Resource * Resource::dirt = new PlantableResource("Dirt", 2 + 4 * 32, Color::get(-1, 100, 322, 432), Tile::dirt, 3, Tile::hole, Tile::water, Tile::lava);
Resource * Resource::sand = new PlantableResource("Sand", 2 + 4 * 32, Color::get(-1, 110, 440, 550), Tile::sand, 2, Tile::grass, Tile::dirt);
Resource * Resource::cactusFlower = new PlantableResource("Cactus", 4 + 4 * 32, Color::get(-1, 10, 40, 50), Tile::cactusSapling, 1, Tile::sand);
Resource * Resource::seeds = new PlantableResource("Seeds", 5 + 4 * 32, Color::get(-1, 10, 40, 50), Tile::wheat, 1, Tile::farmland);
